...
@section('content')
    ...
    <script>
            ...
            $('#tambah_proses').click(function() {
                ...
                $('#proses_field').append(
                    ...
                    '"></div> <div class="col-1" style="text-align:right;">' + (i - l == 1 ?
                        '<a type="button" class="btn qq delicious-btn btn-5 m-1" id="' +
                        i +
                        '"style="font-size: 12px; min-width:20px; border-radius: 1000px"' +
                        'id = "hapus_proses" >' +
                        'Hapus </a>' : '') +
                ...
                alertify.success('Penambahan Proses Berhasil');
            })
        })
        $(document).ready(function() {
            $('#tambah_bahan').click(function() {
                ...
                $('#bahan_field').append(
                    ...
                    '"></div> <div class="col-1" style="text-align:right;"> <a type="button" class="btn pp delicious-btn btn-5 m-1" id="' +
                    j +
                    '"style="font-size: 12px; min-width:20px; border-radius: 1000px"' +
                    'id = "tambah_proses" >' +
                    'Hapus </a></div> </div> </div>'
                );
                alertify.success('Penambahan Bahan Berhasil');
            })
        })
        $(document).on('click', '.qq', function() {
            ...
            alertify.error('Proses terhapus');
        });
        ...
        function validateForm(e) {
            ...
            if (nama == "" || kategori == "" || persiapan == "" || proses == "" || porsi == "" || gambar == "") {
                alertify
